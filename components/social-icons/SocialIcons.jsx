...
import { IconBrandGmail, IconBrandInstagram, IconBrandLetterboxd, IconBrandMailgun, IconMail } from "@tabler/icons-react";
...
const SocialIcons = () => {
  return (
    <Flex>
      ...
      <ActionIcon size="2.5rem" color="gray" variant="subtle" onClick={() => window.open("mailto:suhasnidgundi@gmail.com", "_blank")}>
        <IconMail
          style={{ width: rem(50), height: rem(50) }}
          stroke={1.5}
        />
